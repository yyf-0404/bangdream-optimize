...
curl https://calc.example.com/api/feedback \
  -F 'payload={"category":"problem","subject":"计算结果异常","content":"复现步骤与预期结果……","contactEmail":"user@example.com","context":{"runtime":"browser","appVersion":"0.3.4","page":"result"},"website":""};type=application/json' \
