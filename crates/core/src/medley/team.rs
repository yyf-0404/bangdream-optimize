...
use super::scoring::{RawTeamCandidate, SkillMetaCache};
...
fn refresh_candidate_incumbent(
    ...
    if trace {
        eprintln!(
            "medley candidate incumbent refresh: candidates={} solver_candidates={} used_cards={} old_best={} score={} implementation={:?} filter_ms={filter_ms:.3} solve_ms={:.3}",
            raw_candidates.len(),
            candidate_indices.len(),
            used_card_count,
            current_best,
